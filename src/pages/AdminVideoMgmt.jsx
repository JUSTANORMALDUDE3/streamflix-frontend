            ...
            <div className="admin-card glass" style={{ padding: '24px' }}>
                ...
                <div className="user-list mt-4 flex-column gap-2">
                    {loading ? <div className="spinner"></div> : videos.map(video => (
                        <div key={video._id} className="user-list-item flex-row ai-center jc-between" style={{ padding: '12px', background: 'rgba(255,255,255,0.03)', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                            <div className="flex-row gap-3 ai-center">
                                <div style={{ width: '80px', height: '45px', borderRadius: '4px', overflow: 'hidden', background: '#000' }}>
                                    ...
                                    {editingVideoId === video._id ? (
                                        <div className="flex-column gap-2" style={{ marginTop: '4px' }}>
                                            <input
                                                ...
                                                style={{ padding: '4px 8px', fontSize: '0.9rem', width: '250px' }}
                                        ...
                                        <>
                                            <div style={{ fontWeight: 600, color: 'var(--text-main)' }}>{video.title}</div>
